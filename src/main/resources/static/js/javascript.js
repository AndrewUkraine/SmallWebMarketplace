...
$(document).ready(function() {
    ...
    $('#drop-files').on('drop', function(e) {
        var totalImageElements = document.querySelectorAll('img.img-thumbnail').length;
        ...
        if (files.length <= maxFiles) {
            ...
            loadInView(files);
        }  else { alert('Вы не можете иметь больше '+maxFiles+' изображений! Вы уже имеете '  + totalImageElements);
    ...
    function loadInView(files) {
        ...
        $.each(files, function(index, file) {
            ...
            if((dataArray.length+files.length + totalImageElements) <= maxFiles) {
    ...
    $('#upload-button .upload').click(function() {
        ...
        $.each(dataArray, function(index, file) {
            ...
            $.post('/offer', dataArray[index], function(data) {
