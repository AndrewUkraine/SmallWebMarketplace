...
import com.marketplace.project.web.dto.PasswordForgotDto;
...
public class PasswordForgotController {
    ...
    public String processForgotPasswordForm(@ModelAttribute("forgotPasswordForm") @Valid PasswordForgotDto form,
       ...
       else if (tokenRepository.findAllByUser(user.getId())!=null){
            PasswordResetToken token = tokenRepository.findByToken(user.getPasswordResetToken().getToken());
